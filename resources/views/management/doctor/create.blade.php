            ...
            <div class="p-4 md:p-5">
                ...
                <form class="space-y-4" action="{{ route('doctor.store') }}" method="POST">
                    ...
                    <div id="WorkData" class="tabcontent" style="display:none;">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="contractTypes"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">*
                                    {{ __('Tipos de contrato empleado') }}</label>
                                <select name="employee_contract_types_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                    <option selected disabled>seleccione..</option>
                                    @foreach ($contractTypes as $employee)
                            ...
                            <div>
                                <label for="unitTypes"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">*
                                    {{ __('Tipos de Unidad Organizacional') }}</label>
                            ...
                            {{-- <label for="employee_type">Tipo de Persona:</label>
                            <select name="employee_type" id="employee_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                          ...
                          {{-- <div>
                                ...
                                <select name="schedule" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                                    <option selected disabled>seleccione..</option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phone_number" placeholder="07-98-645"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                        required />
                                </div>
                            </div>
