                    ...
                    <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                        ...
                        <tbody>
                            @php
                                ...
                                $day_week = ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo'];
                            @endphp
                                        ...
                                        @php
                                            ...
                                            foreach ($schedules as $schedule) {
                                                if (
                                                    ...
                                                    break; // Salimos del bucle si encontramos un doctor
                                                }
                                            }
                                        @endphp
                                        <td
                                            class="py-2 px-4 border-b border-gray-300 text-center {{ $name_doctor ? 'bg-green-100' : 'bg-red-100' }} relative group">
                                            {{ $name_doctor ?: ' ' }}
                                            <div
                                                ...
                                                {{ $name_doctor ? 'Doctor disponible' : 'Sin ' }}
                                            </div>
                                        </td>
                                    @endforeach
                                </tr>
