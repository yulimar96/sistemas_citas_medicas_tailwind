   <div id="doctor_schedule" tabindex="-1" aria-hidden="true" data-dialog-backdrop="doctor_schedule"
           ...
           <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
               ...
               <div
                   ...
                   <button type="button"
                       ...
                       data-modal-hide="doctor_schedule">
               ...
               <div class="p-4 md:p-5">
                   <form class="space-y-4" action="{{ route('doctor_schedule.store') }}" method="POST">
                       @csrf
                               ...
                               <select name="doctor_id" id=""
                                   ...
                                   @foreach ($doctors as $doctor)
                                       <option value="{{ $doctor->id }}">
                                           {{ $doctor->person->id.' '.$doctor->person->name_1 . ' ' . $doctor->person->surname_1 . ' | ' . ($doctor->speciality ? $doctor->speciality->name : 'Sin especialidad') }}
                                       </option>
                                   @endforeach
                               </select>
                           </div>
                           <div>
                               ...
                               <select name="organization_unit_id" id=""
                                   ...
                                   @foreach ($organizational_unit as $u)
                                       <option value="{{ $u->id }}">{{  $u->id .' '.$u->name . ' ' . $u->location }}
                                       </option>
                                   @endforeach
                               </select>
                           </div>
