<x-guest-layout>
    <style>
        body {
            /* linear-gradient(#00ffff26, #0087ff, #0087ff) */
            background-image: url('{{ asset('img/img-modal.jpg') }}'); /* Ruta de la imagen de fondo */
    ...
    box-shadow: var(--tw-ring-offset-shadow, 20 0 #4a0404), var(--tw-ring-shadow, 0 0 #000000f0), var(--tw-shadow);
        ...
        .login-button {
            background-color: #27445D; /* Color de fondo del botón */
            color: white; /* Color del texto del botón */
        }

        .login-button:hover {
            background-color: #71BBB2; /* Color de fondo del botón al pasar el mouse */
        }
